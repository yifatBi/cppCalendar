...
${OBJECTDIR}/MyDate.o: MyDate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyDate.o MyDate.cpp

${OBJECTDIR}/myMain.o: myMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myMain.o myMain.cpp
...
${OBJECTDIR}/MyDate_nomain.o: ${OBJECTDIR}/MyDate.o MyDate.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyDate_nomain.o MyDate.cpp;\
	else  \
...
${OBJECTDIR}/myMain_nomain.o: ${OBJECTDIR}/myMain.o myMain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/myMain_nomain.o myMain.cpp;\
	else  \
...
${OBJECTDIR}/welcome_nomain.o: ${OBJECTDIR}/welcome.o welcome.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/welcome_nomain.o welcome.cc;\
	else  \
